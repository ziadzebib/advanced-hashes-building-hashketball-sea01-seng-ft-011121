def game_hash
  game_hash = {
    :home => {
      ...
      :colors => ["Black", "White"],
      :players => [ 
        { {:Alan_Anderson} :player_name => "Alan_Anderson", :number => 0, :shoe => 16, :points => 22, :rebounds => 12, :assists => 12, :steals => 3, :blocks => 1, :slam_dunks => 1}, 
        {:player_name => "Reggie_Evans", :number => 30, :shoe => 14, :points => 22, :rebounds => 12, :assists => 12, :steals => 12, :blocks => 12, :slam_dunks => 7}, 
